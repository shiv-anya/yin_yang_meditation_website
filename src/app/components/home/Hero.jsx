...
export default function Hero() {
  return (
    <section className="flex h-[120vh] max-lg:flex-col max-lg:h-[140vh]">
      <div className="w-[80%] p-16 flex flex-col justify-evenly pb-0 max-lg:h-[50%] max-sm:w-[90%] max-sm:px-0 max-sm:py-8 max-sm:mx-auto max-sm:justify-between">
        ...
        <h2
          className={`text-[4.5rem] leading-[70px] max-lg:text-[3rem] max-lg:leading-[50px] max-lg:my-5`}
        >
        ...
        <Button className="p-4 px-16 rounded-md self-start max-lg:my-5">
          All Courses
        </Button>
      </div>
      <div className="w-[50%] relative m-16 max-lg:h-[40%] max-lg:self-center max-lg:item-center max-sm:mt-24">
        <Image
        ...
        />
        <Button className="absolute top-[40%] left-[40%] h-[90px] w-[90px] rounded-[50%] z-50 max-sm:hidden">
          <FaPlay
